...
# Open the 'love_sandwiches' Google Sheet
...
def calculate_surplus_data(sales_row):
    ...
    stock_row = stock[-1]  # Get the most recent stock data
    ...
    print("Surplus data calculated:", surplus_data)
    return surplus_data
...
def main():
   ...
   #update_sales_worksheet(sales_data)
    ...
    # Calculate and update surplus data
